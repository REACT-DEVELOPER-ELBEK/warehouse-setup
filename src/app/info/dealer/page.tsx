...
import { Layout, Menu, Button, theme, Dropdown, Typography, Table, Input, Space, Modal } from "antd";
...
const Warehouse: React.FC = () => {
  ...
  useEffect(() => {
    async function fetchInfoSection(){
        try {
            const response = await instance("info/dealer")
  ...
  return (
    <>
      ...
      >
        ...
        <Table
          dataSource={infoData&&infoData.map((item: any) => ({
            key: item.id,
